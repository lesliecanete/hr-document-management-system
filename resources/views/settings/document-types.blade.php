...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('document-types.index') }}" class="row g-3">
                <div class="col-md-6">
                    <div class="input-group">
                        <input type="text" 
                               ...
                               placeholder="Search by document type name or description...">
        ...
        <div class="card-body">
            ...
            @else
                <div class="alert alert-info">
                    <i class="fas fa-info-circle"></i> No document types found.
                </div>
            @endif
        </div>
    </div>
            ...
            <form id="editDocumentTypeForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="edit_retention_years" name="retention_years" min="0" required>
                    </div>
