...
@section('title', 'Submitting Party Details')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-1">
                        <i class="fas fa-user-tie text-primary"></i> Submitting Party Details
                    </h1>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-id-card text-muted"></i> Submitting Party Information
                    </h5>
                </div>
                <div class="card-body">
                    @if(session('success'))
                    ...
                    <div class="row">
                            ...
                            <div class="card border-0 bg-light h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="mb-0 fs-5">{{ $applicant->position }}</p>
                                    </div>
                                    <div class="mb-3">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card border-0 bg-light h-100">
                                <div class="card-body">
                                    <h6 class="card-subtitle mb-3 text-primary">
                                        <i class="fas fa-info-circle me-1"></i> Submitting Party Details
                                    </h6>
                                    <div class="mb-3">
